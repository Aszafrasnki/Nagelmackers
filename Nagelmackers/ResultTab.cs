...
namespace Nagelmackers
{
    internal class ResultTab
    {
        ...
        public ResultTab(int departure_time, int arrival_time, int index_of_carrier, int travel_time, double ticket_price)
        {
        ...
        public double TicketPrice { get => ticket_price; set => ticket_price = value; }
